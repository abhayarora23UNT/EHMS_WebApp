	...
	<table class="table" id="myTable">
										...
										<tbody>
											...
											<tr>
												...
												<td class="action">
													<a href="consultation.php?Email=<?php echo $row['Email'];?>" tooltip-placement="top" tooltip="Edit"><i class="fa fa-pencil"></i></a>
													<a href="view_patient_details.php?patient_view_id=<?php echo $row['Email'];?>"><i class="fa fa-eye"></i></a>
												</td>
											</tr>
											<?php $count=$count+1;
										}
