	...
	<table class="table" id="myTable">
										...
										<tbody>
											...
											<tr>
												...
												<td><a href="appointment_history.php?Appointment__id=<?php echo $row['Appointment_id']?>&del=delete" onClick="return confirm('Are you sure you want to Approve')"> <i class="fas fa-check"></i></a></td>
											<?php $count=$count+1;
										}
											?>
										</tbody>
