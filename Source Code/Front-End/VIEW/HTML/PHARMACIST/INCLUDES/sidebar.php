    ...
    <div class="admin__header">
        <div class="admin__header__content">
            ...
            <div class="notification__area">
                <?php
    $sql="SELECT * FROM table_pharmacy WHERE Status='Not Prescribed'";
    ...
    $Not_approved=mysqli_num_rows($query);
     ?>
            ...
            <div class="user__session">
                <h5><?php echo 'Phar.'.strtolower(ucfirst($_SESSION['Pharmacist'])); ?></h5>
            </div>
            <?php
 $User=$_SESSION['Pharmacist_Email'];
  $sql="SELECT * FROM table_pharmacist WHERE Email ='$User'";
  $query=mysqli_query($conn,$sql);
 ?>
