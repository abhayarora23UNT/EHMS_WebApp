											...
											<tr>
												...
												<td class="action">
													<a href="View_prescription.php?Id=<?php echo $row['Id'];?>"><i class="fa fa-eye"></i></a>
														...
														<td><a href="manage_patients.php?Prescription_id=<?php echo $row['Id']?>&del=delete" onClick="return confirm('Are you sure you want to Confirm Prescription to <?php echo $$row['Name']; ?>')"> <i class="fas fa-check"></i></a></td>
