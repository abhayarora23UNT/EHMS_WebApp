...
<html lang="en" dir="ltr">
  <head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0">.
       ...
       <link rel="stylesheet" href="../../fontawesome/css/all.css">
    <title>Technician | Reset password</title>
  </head>
  <body class="admin__login">
    <div class="wrapper">
      ...
      <form class="" action="../../../CONTROL/LAB_TECHNICIAN/password_reset.contr.php" method="post">
        <fieldset>
							<legend>
								Password Reset
							</legend>
              ...
              <div class="donthaveaccount">
                Already have an account?<a href="../lab_technician_login.php"> Login</a>
              </div>
              	</div>
