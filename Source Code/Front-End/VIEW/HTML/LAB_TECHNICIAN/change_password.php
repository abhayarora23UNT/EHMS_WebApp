...
<html lang="en">
	<head>
		<title>Lab Technician | Change Password</title>
    <meta charset="utf-8">
...
<div id="section__content" class="section__content">
	<section id="admin__dashboard" class="admin__dashboard">
		<h1>Lab Technician | Change Password</h1>
	</section>
  ...
  <div class="adddoctor__content">
    ...
    <form class="contactus__form" action="../../../CONTROL/LAB_TECHNICIAN/change_pass_contr.php" method="post">
