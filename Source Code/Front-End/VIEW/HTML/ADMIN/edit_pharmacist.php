...
<head>
    <title>Admin | Edit Pharmacist</title>
    <meta charset="utf-8">
...
<body>
    ...
    <div id="section__content" class="section__content">
        <section id="admin__dashboard" class="admin__dashboard">
            <h2 style="padding-left:15px">Admin | Edit Pharmacist Details</h2>
        </section>
        <div class="adddoctor__main" style="display:flex;justify-content:center">
            <div class="adddoctor__content">
                <div class="adddoctor__title">
                    <h5>Edit Pharmacist Info</h5>
                    <?php
			$Email           =$_GET['Email'];
      $sql="SELECT * FROM table_pharmacist WHERE Email='$Email'";
...
?>
                ...
                <form class="contactus__form" action="../../../CONTROL/ADMIN/edit_pharmacist.contr.php" method="POST">
