  ...
  <div class="adddoctor__content">
    ...
    <div class="form__inputs">
      ...
      <i class="fas fa-user"></i>
        ...
        <input type="text" name="Mothername"  placeholder=" Mother's Full Name" required style="color:black;"><br>
				<div class="usericon">
	      <i class="fas fa-user"></i>
	        </div>
	        <input type="text" name="Fathername"  placeholder=" Father's Full Name" required style="color:black;"><br>
					<div class="usericon">
          <i class="fa fa-phone"></i>
          </div>
          <input type="text"  name="Motherphone" placeholder="Mother's Phone" required style="color:black;"><br>
					<div class="passicon">
          <i class="fa fa-phone"></i>
          </div>
         <input type="text"name="Fatherphone" placeholder="Father's Phone" required style="color:black;"><br>
        <div class="passicon">
        ...
        <input type="text"name="Infantname" placeholder="Infant's Name" required style="color:black;"><br>
