...
<body>
    ...
    <div id="section__content" class="section__content">
        <section id="admin__dashboard" class="admin__dashboard">
            <h2 style="padding-left:15px">Admin | Manage Doctors</h2>
        </section>
        ...
        <table class="table" id="myTable" style="margin-left:18px;margin-top:30px">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><?php echo $date;?></td>
                    <td class="action">
                        <a href="edit_doctor.php?Email=<?php echo $row['Email'];?>" tooltip-placement="top"
                            tooltip="Edit"><i class="fa fa-pencil"></i></a>
                        <a href="manage_doctor.php?Email=<?php echo $row['Email']?>&del=delete"
                            onClick="return confirm('Are you sure you want to delete Doctor <?php echo $row['Name']; ?>')">
