...
if (!isset($_SESSION['username']) && !isset($_SESSION['password'])) {
	...
	if(isset($_GET['Email'])){
		$Email=$_GET['Email'];
		$sql="DELETE FROM table_doctor WHERE Email='$Email'";
		$query=mysqli_query($conn,$sql);

		if($query){
			$success="Doctor deleted from the system successfully";
	                      ...
	                      <th class="action">Action</th>
										...
										<tbody>
											...
											<tr>
												...
												<td><?php echo $date;?></td>
												<td class="action">
<a href="edit_doctor.php?Email=<?php echo $row['Email'];?>" tooltip-placement="top" tooltip="Edit"><i class="fa fa-pencil"></i></a>
<a href="manage_doctor.php?Email=<?php echo $row['Email']?>&del=delete" onClick="return confirm('Are you sure you want to delete Doctor <?php echo $row['Name']; ?>')"> <i class="fa fa-times fa fa-white"></i></a>
												</td>
											</tr>
											<?php $count=$count+1;
										}
