	                      ...
	                      <th class="action">Action</th>
										...
										<tbody>
											...
											<tr>
												...
												<td><?php echo $date;?></td>
												<td class="action">
<a href="edit_pharmacist.php?Email=<?php echo $row['Email'];?>" tooltip-placement="top" tooltip="Edit"><i class="fa fa-pencil"></i></a>
<a href="manage_pharmacist.php?Email=<?php echo $row['Email']?>&del=delete" onClick="return confirm('Are you sure you want to delete Pharmacist <?php echo $row['Name']; ?>')"> <i class="fa fa-times fa fa-white"></i></a>
												</td>
											</tr>
											<?php $count=$count+1;
										}
