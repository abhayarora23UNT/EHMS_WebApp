...
<div id="section__content" class="section__content">
	...
	<div class="view__patients">
		<div class="view__patients__content">
			...
			<input type="text" id="date_search" onkeyup="date_search()"required value="" placeholder="Select date...">
			<input type="text" id="myInput" onkeyup="mySearch()"required value="" placeholder="eg. abc@gmail.com">
				</div>
		</div>
	</div>
