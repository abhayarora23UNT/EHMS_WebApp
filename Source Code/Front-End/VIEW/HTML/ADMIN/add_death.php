  ...
  <div class="adddoctor__content">
    ...
    <div class="form__inputs">
      ...
      <i class="fas fa-user"></i>
        ...
        <input type="text"  name="Nextofkinname" placeholder="Next of kin name" required style="color:black;">
				<div class="passicon">
        ...
        <i class="far fa-building"></i>
          ...
          <input type="text" name="City"  placeholder="City" required><br>
				 <textarea class="death__reason" name="Deathreason" rows="3" cols="73.9" maxlength="100" required placeholder="Cause of the death" style="color:black;"></textarea><br>
