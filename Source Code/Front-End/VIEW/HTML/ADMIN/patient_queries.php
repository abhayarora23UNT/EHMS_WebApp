	...
	<table class="table" id="myTable">
										...
										<tbody>
											...
											<tr>
												...
												<td class="action">
													<a href="view_contactus_msgs.php?msgid=<?php echo $row['Msg_id'];?>" onclick="Status_color();"><i class="fa fa-eye"></i></a>
													<a href="patient_queries.php?Msg_id=<?php echo $row['Msg_id']?>&del=delete" onClick="return confirm('Are you sure you want to delete this msg from <?php echo $row['Name']; ?>')"> <i class="fa fa-times fa fa-white"></i></a>
												</td>
											</tr>
											<?php $count=$count+1;
										}
