...
if (!isset($_SESSION['username']) && !isset($_SESSION['password'])) {
	...
	if(isset($_GET['Email'])){
		$Email=$_GET['Email'];
		$sql="DELETE FROM table_nurse WHERE Email='$Email'";
	...
	<table class="table" id="myTable">
										...
										<tbody>
											...
											<tr>
												...
												<td><?php echo $date;?></td>
												<td class="action">
	<a href="edit_nurse.php?Email=<?php echo $row['Email'];?>" tooltip-placement="top" tooltip="Edit"><i class="fa fa-pencil"></i></a>
	<a href="manage_nurse.php?Email=<?php echo $row['Email']?>&del=delete" onClick="return confirm('Are you sure you want to delete Nurse <?php echo $row['Name']; ?>')"> <i class="fa fa-times fa fa-white"></i></a>
												</td>
											</tr>
											<?php $count=$count+1;
										}
