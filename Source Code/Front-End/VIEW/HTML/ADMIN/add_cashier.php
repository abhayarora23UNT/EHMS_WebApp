...
<body>
    ...
    <div id="section__content" class="section__content">
        <section id="admin__dashboard" class="admin__dashboard">
            <h2 style="padding-left:15px">Admin | Add Cashier</h2>
        </section>
        <div class="adddoctor__main" style="display:flex;justify-content:center">
            <div class="adddoctor__content">
                ...
                <form class="contactus__form" action="../../../CONTROL/ADMIN/add_cashier_contr.php" method="POST">
