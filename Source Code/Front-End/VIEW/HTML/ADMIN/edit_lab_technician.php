...
<head>
    <title>Admin | Edit Lab Technician</title>
    <meta charset="utf-8">
...
<body>
    ...
    <div id="section__content" class="section__content">
        <section id="admin__dashboard" class="admin__dashboard">
            <h2 style="padding-left:15px">Admin | Edit Technician Details</h2>
        </section>
        <div class="adddoctor__main" style="display:flex;justify-content:center">
            <div class="adddoctor__content">
                <div class="adddoctor__title">
                    <h5>Edit Technician Info</h5>
                    <?php
			$Email           =$_GET['Email'];
      $sql="SELECT * FROM table_lab_technician WHERE Email='$Email'";
...
?>
                ...
                <form class="contactus__form" action="../../../CONTROL/ADMIN/edit_lab_technician.contr.php"
                    method="POST">
                    <div class="contactusform__inputs contactusform__inputs--adddoctor">
                        ...
                        <input type="email" name="Email" value="<?php echo $Email; ?>" required style="color:black;"
                            readonly>
                        <div class="passicon">
