...
<div id="section__content" class="section__content">
    ...
    <div class="view__patients__content">
      ...
      <input type="text" id="myInput" onkeyup="mySearch()"required data-input placeholder="select date ...">
			<input type="text" id="Phone_search" onkeyup="Phone_search()"required data-input placeholder="Search by phone">
        </div>
    </div>
  </div>
	<table class="table" id="myTable">
										...
										<tbody>
											...
											<tr>
												...
												<td class="action">
													<a href="view_patient_details.php?patientid=<?php echo $row['Email'];?>"><i class="fa fa-eye"></i></a>
												</td>
											</tr>
											<?php $count=$count+1;
										}
