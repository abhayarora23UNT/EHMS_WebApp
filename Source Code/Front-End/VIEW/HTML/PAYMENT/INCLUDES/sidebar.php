    ...
    <div id="mySidebar" class="sidenav sidenav-left-border">
        ...
        <div class="sidenav__content sidenav-pad-left">
            ...
            <div class="Patients__content">
                <a href="manage_patients.php">Manage Payments</a><br>
            </div>
    ...
    <div class="admin__header">
        <div class="admin__header__content">
            ...
            <div class="notification__area">
                <?php
    $sql="SELECT * FROM table_payments WHERE Status='Not Paid'";
    $query=mysqli_query($conn,$sql);
    $Not_approved=mysqli_num_rows($query);
     ?>
                <a href="manage_patients.php" class="notification">
                    <span><i class="fas fa-envelope"></i></span>
                    <span class="badge"><?php echo $Not_approved; ?></span>
                </a>
            </div>
            <div class="user__session">
                <h5><?php echo 'Cashier.'.strtolower(ucfirst($_SESSION['Finance'])); ?></h5>
            </div>
            <?php
 $User=$_SESSION['Finance_Email'];
  $sql="SELECT * FROM table_finance WHERE Email ='$User'";
  $query=mysqli_query($conn,$sql);
 ?>
