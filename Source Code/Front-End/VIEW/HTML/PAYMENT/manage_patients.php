										...
										<tbody>
											...
											<tr>
												...
												<td class="action">
													...
													<td><?php echo $Due; ?></td>
														<td><a href="manage_patients.php?payments_id=<?php echo $row['Id']?>&del=delete" onClick="return confirm('Are you sure you want to Confirm Payments from <?php echo $$row['Name']; ?>')"> <i class="fas fa-check"></i></a></td>
