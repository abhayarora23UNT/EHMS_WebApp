                        ...
                        <table class="table table-striped">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td
                                        style="font-weight:bold;border-bottom:2px solid black;border-top:2px solid black;">
                                        <?php echo $Total_amount; ?></td>
                                </tr>
                                <tr>
                                    <td style="text-align:left;font-size:0.9em;font-Weight:bold;">Amount paid Via M-PESA
                                    </td>
                                    <td><input style="border-style:none;outline:none;" type="text" name="mpesa"
                                            placeholder="Enter Amount" value="<?php echo $row['Mpesa']; ?>" required>
                                    </td>
                                <tr>
                                    <td style="text-align:left;font-size:0.9em;font-Weight:bold;">Amount paid in Cash
                                    </td>
                                    <td><input style="border-style:none;outline:none;background-color: #F0F0F9;"
                                            type="text" name="cash" placeholder="Enter Amount"
                                            value="<?php echo $row['Cash']; ?>" required></td>
                                </tr>
                                <tr>
